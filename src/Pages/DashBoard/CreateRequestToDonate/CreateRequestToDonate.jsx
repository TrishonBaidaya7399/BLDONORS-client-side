...
console.log(userInfo[0]);
  ...
  return (
    <div className="flex flex-col border-[3px] rounded-lg lg:p-12 mb-2lg:mb-12 lg:mx-[200px] border-red-500 bg-red-500 bg-opacity-20">
      <div className="flex justify-center">
        <h1 className="text-3xl text-center font-bold pb-2 border-b-[3px] border-red-500 px-4 w-fit">
